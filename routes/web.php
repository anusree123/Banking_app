...
//
//
//Route::get('/category/create', 'CategoryController@create')->middleware(['web','auth']);
//Route::post('/category/store', 'CategoryController@store')->middleware(['web','auth']);
//
//Route::get('/subcategory/create', 'SubCategoryController@create')->middleware(['web','auth']);
//Route::post('/subcategory/store', 'SubCategoryController@store')->middleware(['web','auth']);
